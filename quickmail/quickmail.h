...
DLL_EXPORT_LIBQUICKMAIL void quickmail_set_localname (quickmail mailobj, const char* localname);
DLL_EXPORT_LIBQUICKMAIL const char* quickmail_get_localname (quickmail mailobj);

DLL_EXPORT_LIBQUICKMAIL void quickmail_set_charset (quickmail mailobj, const char* charset);
DLL_EXPORT_LIBQUICKMAIL const char* quickmail_get_charset (quickmail mailobj);

DLL_EXPORT_LIBQUICKMAIL const char *quickmail_set_mail_id(quickmail mailobj, const char *message);
DLL_EXPORT_LIBQUICKMAIL const char* quickmail_get_mail_id (quickmail mailobj);
